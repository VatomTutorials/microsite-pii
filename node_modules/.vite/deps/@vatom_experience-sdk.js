...
// node_modules/@vatom/experience-sdk/src/components/ExperienceProvider.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var import_react4 = __toESM(require_react(), 1);

// node_modules/@vatom/experience-sdk/src/hooks/useMessage.js
var import_react = __toESM(require_react(), 1);
var postMessage = (data, target, origin = "*") => {
  var _a;
  return target ? target == null ? void 0 : target.postMessage(JSON.stringify(data)) : (_a = window == null ? void 0 : window.parent) == null ? void 0 : _a.postMessage(JSON.stringify(data), "*");
};
var useMessage = (watch, eventHandler) => {
  ...
  const onWatchEventHandler = (0, import_react.useCallback)((event) => {
    try {
      const { origin: origin2, source: source2, data: unparsedData } = event;
...
// node_modules/@vatom/experience-sdk/src/components/BusinessProvider.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react2 = __toESM(require_react(), 1);
var BusinessConext = (0, import_react2.createContext)({});
var BusinessProvider = (props) => {
  const [business, setBusiness] = (0, import_react2.useState)();
  const [tokens, setTokens] = (0, import_react2.useState)([]);
  ...
  return (0, import_jsx_runtime.jsx)(BusinessConext.Provider, { value: { business, tokens }, children: props.children });
};

// node_modules/@vatom/experience-sdk/src/components/UserProvider.js
...
var UserProvider = (props) => {
  ...
  const [accessToken, setaccessToken] = (0, import_react3.useState)(null);
  const [campaignUserInfo, setCampaignUserInfo] = (0, import_react3.useState)();
  const [userBusinessInfo, setUserBusinessInfo] = (0, import_react3.useState)();
  ...
  function updateUserCampaignInfo(payload) {
    sendToParent({ type: "UPDATE_CAMPAIGN_USER_INFO", payload });
  }
  function getUserBusinessInfo() {
    sendToParent({ type: "GET_USER_INFO" });
  }
  return (0, import_jsx_runtime2.jsx)(UserContext.Provider, { value: {
    user,
    accessToken,
    campaignUserInfo,
...
// node_modules/@vatom/experience-sdk/src/components/ExperienceProvider.js
var ExperienceContext = (0, import_react4.createContext)({});
var useExperience = () => (0, import_react4.useContext)(ExperienceContext);
var ExperienceProvider = (props) => {
  ...
  const openSpace = (alias) => {
    sendToParent({ type: "OPEN_SPACE", payload: { alias } });
  };
  const callSpace = (alias) => {
    sendToParent({ type: "CALL_SPACE", payload: { alias } });
  };
  return (0, import_jsx_runtime3.jsx)(ExperienceContext.Provider, { value: {
    ...
    navigateToWallet,
    navigateToNFTDetail
  }, children: (0, import_jsx_runtime3.jsx)(UserProvider, { children: (0, import_jsx_runtime3.jsx)(BusinessProvider, { children: props.children }) }) });
};

// node_modules/@vatom/experience-sdk/src/hooks/useBusiness.js
var import_react5 = __toESM(require_react(), 1);
var useBusiness = () => (0, import_react5.useContext)(BusinessConext);

// node_modules/@vatom/experience-sdk/src/hooks/useNativeBackHandler.js
var import_react6 = __toESM(require_react(), 1);
var useNativeBackHandler = (cb) => {
...
// node_modules/@vatom/experience-sdk/src/hooks/useShare.js
var import_react7 = __toESM(require_react(), 1);
var useShare = () => {
  const sharePromise = (0, import_react7.useRef)(null);
  const promiseResolve = (0, import_react7.useRef)(null);
  const promiseReject = (0, import_react7.useRef)(null);
  const clean = () => {
...
// node_modules/@vatom/experience-sdk/src/hooks/useUser.js
...
// node_modules/@vatom/experience-sdk/src/types.js
var ThemesEnum;
(function(ThemesEnum2) {
  ThemesEnum2["light"] = "light";
  ThemesEnum2["dark"] = "dark";
  ThemesEnum2["system"] = "system";
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=@vatom_experience-sdk.js.map
